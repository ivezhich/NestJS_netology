...
import { multerStorage, STORAGE_PATH } from '../middleware/file';
import path from 'node:path';
import { CreateBookDto, BookDto, UpdateBookDto } from './dto/books.dto';
import { BooksRepository } from './books.controller';
...
router.post('/', multerStorage.single('book'),
    async (req, res) => {
        try {
            const repo: BooksRepository = container.get(BooksRepository);
